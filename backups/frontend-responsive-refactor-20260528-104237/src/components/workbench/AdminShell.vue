  ...
  >
    ...
    <aside class="admin-sidebar">
      ...
      <div class="admin-sidebar-tools">
        <button type="button" class="admin-tool-row" :title="sidebarCollapsed ? themeToggleLabel : ''" @click="uiStore.toggleTheme()">
    ...
    <section class="admin-frame">
      <header class="admin-topbar">
        ...
        <div class="admin-topbar-actions">
          ...
          <el-button text class="admin-icon-button admin-theme-button" :title="themeToggleLabel" @click="uiStore.toggleTheme()">
            <el-icon><component :is="themeIcon" /></el-icon>
          </el-button>

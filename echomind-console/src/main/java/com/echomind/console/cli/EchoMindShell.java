...
/**
 * EchoMind 命令行 Shell —— 提供基于 Spring Shell 的交互式 CLI 入口。
 *
...
public class EchoMindShell {
     ...
     *
     * @param provider 目标模型提供商标识（如 "deepseek"）
     * @param model    目标模型名称（如 "deepseek-v4-flash"）
     * @return 切换确认消息
     */
    @ShellMethod("切换当前默认模型")
